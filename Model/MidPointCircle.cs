...
namespace image_filtering_app
{
    ...
    class MidPointCircle : Shape
    {
        ...
        public MidPointCircle(Color color, Color backColor) : base(color)
        {
        ...
        public MidPointCircle(Color color, Point center, int radius, Color backColor) : base(color)
        {
            shapeType = DrawingShape.CIRCLE;
            this.center = center;
            this.radius = radius;
        ...
        {
            Circle circle = new Circle(center.Value, radius.Value);

            return XiaolinWuAlgorithm(bmp, circle.center, circle.radius);
        }

        List<ColorPoint> XiaolinWuAlgorithm(Bitmap bmp, Point center, double radius)
        {
