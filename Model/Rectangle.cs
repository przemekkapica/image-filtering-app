...
namespace image_filtering_app
{
    ...
    class Rectangle : Shape
    {
        ...
        public override List<ColorPoint> GetPixels(params object[] param)
        {
            ...
            points.AddRange(new SymmetricMidPointLine(shapeColor, thickness, startPoint.Value, upperLeft).GetPixels());
            points.AddRange(new SymmetricMidPointLine(shapeColor, thickness, upperLeft, endPoint.Value).GetPixels());
            points.AddRange(new SymmetricMidPointLine(shapeColor, thickness, endPoint.Value, lowerRight).GetPixels());
            points.AddRange(new SymmetricMidPointLine(shapeColor, thickness, lowerRight, startPoint.Value).GetPixels());
        ...
        public override List<ColorPoint> GetPixelsAA(Bitmap bmp)
        {
            ...
            points.AddRange(new SymmetricMidPointLine(shapeColor, thickness, startPoint.Value, upperLeft).GetPixelsAA(bmp));
            points.AddRange(new SymmetricMidPointLine(shapeColor, thickness, upperLeft, endPoint.Value).GetPixelsAA(bmp));
            points.AddRange(new SymmetricMidPointLine(shapeColor, thickness, endPoint.Value, lowerRight).GetPixelsAA(bmp));
            points.AddRange(new SymmetricMidPointLine(shapeColor, thickness, lowerRight, startPoint.Value).GetPixelsAA(bmp));
        ...
        {
            return "Click rectangle's initial vertex and the opposite one";
        }
    }
}
