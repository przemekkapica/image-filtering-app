...
{
    public partial class CustomFilterEditor : Form
    {
        ...
        private ImageFilteringApp imageProcessorForm;
        private string kernel;
        public CustomFilterEditor(Form callingForm, string filter)
        {
            imageProcessorForm = callingForm as ImageFilteringApp;
            kernel = filter;
            InitializeComponent();
            SetUpKernelEditor();
        }
        ...
        private void KernelEditor_Load(object sender, EventArgs e)
        {
